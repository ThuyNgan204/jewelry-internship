...
function createProduct() {
    if(localStorage.getItem('product')===null){
        var productArray = [
            ...
            {productId: 38, name: 'Đồng hồ Daniel Wellington Nữ Dây thép không gỉ 26 mm', category: 'dong-ho', price: 4970000, img: ['../assets/products/watch/T058.109.11.041.00_Desktop_1.jpg'], description: 'Daniel Wellington - Thương hiệu Đồng hồ Thụy Điển, đại diện cho phong cách tối giản, kết hợp với sự tinh tế và cổ điển để từ đó tạo nên những món phụ kiện thời trang thanh lịch, trang nhã và thời thượng. Đến nay thương hiệu này vẫn luôn đứng đầu là một trong những thương hiệu Đồng hồ và Trang sức được yêu thích trên toàn cầu.'},
            {productId: 39, name: 'Đồng hồ Tissot T-Lady Nữ', category: 'dong-ho', price: 13690000, img: ['../assets/products/watch/T058.109.33.456.00_Desktop_1.jpg'], description: 'Đồng Hồ Tissot T-Lady Nữ Dây Thép Không Gỉ là mẫu đồng hồ nữ đẳng cấp, kết hợp hoàn hảo giữa thiết kế tinh tế và chất liệu cao cấp. Với dây thép không gỉ bền bỉ, đồng hồ này mang lại vẻ đẹp sáng bóng và chắc chắn, đồng thời tạo cảm giác thoải mái và dễ chịu khi đeo.'},
            {productId: 40, name: 'Đồng hồ Fossil Nữ Dây thép không gỉ 35 mm', category: 'dong-ho', price: 4890000, img: ['../assets/products/watch/WFO00000135-ES4301_Desktop_1.jpg'], description: 'Đồng hồ Fossil Nữ Dây Thép Không Gỉ là một lựa chọn hoàn hảo cho những cô nàng yêu thích sự kết hợp giữa phong cách cổ điển và hiện đại. Với thiết kế thanh lịch, chiếc đồng hồ này mang đến vẻ đẹp sang trọng và tinh tế, phù hợp với nhiều dịp khác nhau, từ công sở đến những buổi tiệc sang trọng. Dây đồng hồ được làm từ thép không gỉ chất lượng cao, không chỉ bền bỉ và chống oxy hóa mà còn mang lại cảm giác thoải mái khi đeo.'},
            {productId: 41, name: 'Đồng hồ Fossil Nữ Dây da 28 mm', category: 'dong-ho', price: 3080000, img: ['../assets/products/watch/WFO00000296-ES4502_Desktop_1.jpg'], description: 'Đồng Hồ Fossil Nữ Dây Da là sự kết hợp tuyệt vời giữa phong cách cổ điển và sự tinh tế hiện đại, mang đến cho phái đẹp một phụ kiện không thể thiếu trong bộ sưu tập của mình. Dây đồng hồ được làm từ da thật, mềm mại nhưng vô cùng bền bỉ. Chất liệu da tự nhiên không chỉ mang đến cảm giác thoải mái khi đeo mà còn giúp tăng cường sự sang trọng, cổ điển cho chiếc đồng hồ.'},
            ...
            {productId: 43, name: 'Đồng hồ Tissot T-lady Nữ Dây da 26 mm', category: 'dong-ho', price: 14060000, img: ['../assets/products/watch/WTI00000627-T126.010.36.013.00_Desktop_1.jpg'], description: 'Đồng Hồ Tissot T-Lady Nữ Dây Da là sự lựa chọn hoàn hảo cho phái đẹp yêu thích sự tinh tế và thanh lịch. Với thiết kế mặt đồng hồ cổ điển, chiếc đồng hồ này mang đến vẻ đẹp sang trọng và nữ tính. Dây da cao cấp mềm mại, vừa vặn ôm tay, tạo cảm giác thoải mái khi đeo suốt cả ngày.'},
        ];
    ...
    if (temp[1]=='' || temp[1]==undefined || temp[1].search('all')==0){
        ...
        for (var i = vitri; i < productArray.length; i++){
            x += '<div class="card">'+
                        ...
                        '<p>' + currency(productArray[i].price) +'</p>'+
