...
function createProducts() {
    if(localStorage.getItem('products')===null){
        var productArray = [
            {productId: 1, name: 'Vòng tay Vàng trắng Ý 18K', category: 'bracelet', price: 15400000, img: ['../assets/products/bracelet/sp-gv0000w060448-vong-tay-vang-y-18k-pnj-1.png', '../assets/products/bracelet/on-gv0000w060448-vong-tay-vang-y-18k-pnj-1.jpg', '../assets/products/bracelet/on-gv0000w060448-vong-tay-vang-y-18k-pnj-2.jpg', '../assets/products/bracelet/on-gv0000w060448-vong-tay-vang-y-18k-pnj-3.jpg'], description: 'Chiếc vòng tay LUXGEM sở hữu sự cứng cáp của vàng Ý 18K được chế tác tinh xảo, kết hợp các chi tiết đúc, châu và khắc theo công nghệ trang sức Ý, tạo nên sự sáng bóng và sang trọng. Với thiết kế độc lạ cùng ánh kim sắc sảo, sản phẩm sẽ tôn lên vẻ đẹp của các quý cô. Thêm vào đó, với thiết kế tinh xảo của vòng tay, nàng sẽ bất ngờ khi phối với các bộ trang phục như suit công sở hay những chiếc đầm dạo phố. Với các điểm nhấn trên sản phẩm, LUXGEM tin rằng nàng sẽ trở nên thật sự tỏa sáng và nổi bật khi trưng diện chúng.'},
            ...
            {productId: 5, name: 'Vòng tay Vàng trắng 14K đính đá Tanzanite', category: 'bracelet', price: 172100000, img: ['../assets/products/bracelet/sp-gvtzmxw000001-vong-tay-vang-trang-14k-dinh-da-tanzanite-pnj-masterpiece-1.png'], description: 'Vòng tay được chế tác từ Vàng Trắng 14K đính đá chủ Tanzanite quý hiếm biểu tượng cho sự bí ẩn và nổi bật bên những viên kim cương và sapphire xanh trải dài quanh chiếc vòng - biểu tượng của sự tự do, chuyển động và vĩnh cửu. Bàn tay nghệ nhân tỉ mỉ khắc họa nên Hạ Long không chỉ với vẻ đẹp hùng vĩ, mà còn là sự hài hòa giữa chuyển động và tĩnh tại, vẻ đẹp giao hòa giữa thiên nhiên và nghệ thuật, khiến ta không khỏi ngước nhìn, chiêm ngưỡng.'},
            {productId: 6, name: 'Vòng tay Vàng trắng 10K đính đá ECZ', category: 'bracelet', price: 14298000, img: ['../assets/products/bracelet/sp-gvxmxmw001458-vong-tay-vang-trang-10k-dinh-da-ecz-pnj-hello-kitty-1.png'], description: 'Tôn vinh vẻ đẹp kiêu sa của quý cô, chiếc vòng tay vàng 10K chắc chắn sẽ là điểm nhấn cho cả outfit. Sức hút riêng của thiết kế được kết tạo từ thiết kế cực kì duyên dáng với điểm nhấn đính đá ECZ cách điệu tinh xảo, tạo nên sản phẩm tinh tế chinh phục mọi ánh nhìn.'},
            ...
            {productId: 27, name: 'Nhẫn Bạc', category: 'ring', price: 395000, img: ['../assets/products/ring/sp-sn0000w060028-nhan-bac-dinh-da-pnjsilver-1.png'], description: 'Hãy khám phá và để những thiết kế rực rỡ đầy màu sắc của truyền cảm hứng cho bạn kể câu chuyện mang đậm chất riêng của mình một cách đầy thú vị. Sở hữu thiết kế độc đáo với những điểm nhấn đá đầy màu sắc lấp lánh, chiếc nhẫn bạc STYLE By LUXGEM sẽ tôn lên vẻ đẹp cá tính và tinh tế của nàng xinh.'},
            ...
            {productId: 35, name: 'Đồng hồ Disney Watch Nữ Dây kim loại 25 mm', category: 'watch', price: 2050000, img: ['../assets/products/watch/sp-wfdiqfw0m25.0019-dong-ho-disney-watch-nu-mk-11626w-day-kim-loai-25-mm-1.png'], description: 'Khám phá sự kết hợp hoàn hảo giữa phong cách thời trang và vẻ đẹp dễ thương của các nhân vật Disney với Đồng hồ Disney Watch Nữ Dây Kim Loại. Đồng hồ sở hữu thiết kế đặc biệt dành cho những tín đồ yêu thích vẻ đẹp độc đáo và cá tính của các nhân vật hoạt hình Disney kết hợp với dây kim loại chắc chắn và sang trọng.'},
            ...
            {productId: 41, name: 'Đồng hồ Tissot T-Classic Nam Dây thép không gỉ 39 mm', category: 'watch', price: 20650000, img: ['../assets/products/watch/sp-wmtiaw00s39.0013-dong-ho-tissot-t-classic-nam-t065.430.22.031.00-day-thep-khong-gi-39mm-1.png'], description: 'Đồng Hồ Tissot T-Classic Nam Dây Thép Không Gỉ là mẫu đồng hồ đẳng cấp dành cho phái mạnh, mang đến vẻ ngoài sang trọng và tinh tế. Dây thép không gỉ cao cấp không chỉ mang đến sự chắc chắn mà còn tạo cảm giác thoải mái và dễ chịu khi đeo.'},
            {productId: 42, name: 'Đồng hồ Skagen Nữ Dây thép không gỉ 26 mm', category: 'watch', price: 4120000, img: ['../assets/products/watch/wkf33b03545.100-skw2665-dong-ho-thoi-trang-nu-day-thep-khong-gi-chong-nuoc-skagen.png'], description: 'Đồng hồ Skagen nữ dây thép không gỉ là một biểu tượng của sự tinh tế và thanh lịch, mang đến cho người sở hữu không chỉ công năng tuyệt vời mà còn là một phụ kiện thời trang hoàn hảo. Mặt đồng hồ với các chi tiết tinh tế, giúp bạn cảm thấy thoải mái và tự tin mỗi khi đeo. Sự kết hợp giữa dây thép không gỉ và mặt đồng hồ mỏng nhẹ tạo nên vẻ đẹp nhẹ nhàng, thanh thoát nhưng không kém phần sang trọng.'},
            {productId: 43, name: 'Đồng hồ Tissot T-Classic Nam Dây thép không gỉ 39.3 mm', category: 'watch', price: 21900000, img: ['../assets/products/watch/wdp11d03200.000-d006.407.11.053.00-dong-ho-nam-day-thep-khong-gi-tissot.png'], description: 'Đồng Hồ Tissot T-Classic Nam Dây Thép Không Gỉ là mẫu đồng hồ đẳng cấp dành cho phái mạnh, mang đến vẻ ngoài sang trọng và tinh tế. Dây thép không gỉ cao cấp không chỉ mang đến sự chắc chắn mà còn tạo cảm giác thoải mái và dễ chịu khi đeo'},
        ];
